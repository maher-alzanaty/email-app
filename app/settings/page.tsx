...
const [activePanel, setActivePanel] = useState<string | null>(null);
 ...
 x
        ...
        {/* Search Bar */}
     <div
  className="flex items-center gap-3 h-12 bg-[#0D034A1A] rounded-md px-4 absolute top-3 left-6"
...
>
  ...
  <input
    type="text"
    placeholder="Search"
    className="flex-1 h-full bg-transparent border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-[#14004D] placeholder-gray-500 text-gray-700 px-2"
  />
  ...
  <Image src="/srchl.png" width={16} height={16} alt="Search Icon" />
        ...
        {/* ================= SETTINGS CONTENT ================= */}
      <div className="flex flex-1 mt-12 overflow-hidden" style={{ width: "calc(100% - 5em)" }}>
